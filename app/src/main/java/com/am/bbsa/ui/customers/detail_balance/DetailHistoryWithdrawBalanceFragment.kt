...
class DetailHistoryWithdrawBalanceFragment : Fragment() {
            ...
            when (it.status) {
                "COMPLETED" -> {
                    ...
                    binding.textStatus.text = buildString {
                        append("Status pengiriman berhasil")
                    }
                    binding.textValueFailureCode.text = buildString {
                        append("Berhasil")
                    }
                }
                ...
                "PENDING" -> {
                    ...
                    binding.textStatus.text = buildString {
                        append("Status pengiriman gagal")
                    }
