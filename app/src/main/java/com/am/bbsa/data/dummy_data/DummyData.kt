...
object DummyData {
    ...
    val DummyDataCardMenu = arrayListOf(
        ...
        DummyModel.DataCard(2, R.string.sales_result, R.drawable.icon_penjualan),
        DummyModel.DataCard(
            3, R.string.customer_deposit_waste, R.drawable.icon_customer_deposit_waste
        ),
        DummyModel.DataCard(4, R.string.waste_deposit, R.drawable.icon_waste_deposit),
        ...
        DummyModel.DataCard(8, R.string.waste_type_information, R.drawable.icon_type_waste_information),
